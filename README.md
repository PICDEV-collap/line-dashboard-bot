...
> **คู่มือใช้งาน LINE Bot (พนักงาน / คำสั่งแก้ไข / Changelog):** [docs/BOT-GUIDE.md](docs/BOT-GUIDE.md)
...
Bot ตอบสรุปรายรับ / รายจ่าย / กำไร และแจ้งค่าที่ดึงจากวันก่อน (ถ้ามี)

**คำสั่งแก้ไขหลังบันทึกแล้ว:**
...
ดูรายละเอียดทั้งหมดใน **[docs/BOT-GUIDE.md](docs/BOT-GUIDE.md)**
...
├── docs/
│   └── BOT-GUIDE.md        # คู่มือ LINE Bot + Changelog
├── supabase/
...
│       │   ├── financial-parser.service.ts    # Gemini + regex hybrid parse
│       │   ├── financial-correction.service.ts # แก้/ปรับ/ลบ via LINE
│       │   ├── smart-command.service.ts       # แยกคำติดกัน (ภาษาพูดไทย)
│       │   ├── recurring-expenses.service.ts  # carry-forward ค่าใช้จ่ายประจำ
