...
คำสั่งที่ระบบรองรับ (canonical):
- "สรุป" = ดูสรุปยอดวันนี้ (สาขาเริ่มต้น)
- "สรุปทุกสาขา" = สรุปทั้งสองสาขา
- "สรุปหนองปิง" หรือ "สรุปญี่ปุ่น" = สรุปสาขาที่ระบุ
- "ค่าหมูทั้งหมด" = ดูยอดค่าหมูรวม
- "รายงาน" / "รายงานเดือนนี้" / "รายงานเดือนที่แล้ว" / "รายงานปีนี้" = ออกรายงาน PDF
- "ช่วย" = ดูวิธีใช้/คำสั่งทั้งหมด
- คำสั่งแก้ไขข้อมูล เช่น "แก้ ...", "ลบ ...", "เอาหมูแดงออก 1"

สิ่งที่ถือเป็น "financial" (การบันทึกยอด ไม่ใช่คำสั่ง):
- มีตัวเลขรายรับ/รายจ่าย/จำนวนหมู เช่น "โอน 5000 สด 3000", "หมูแดง 4 กก 130", "แม็คโคร 2500", "ได้คนละครึ่ง 450"

ตอบเป็น JSON เท่านั้น (ห้ามมีข้อความอื่น):
{"type":"command"|"financial"|"unknown","canonical":"<คำสั่ง canonical ถ้า type=command, ไม่งั้นเว้นว่าง>","confidence":0.0-1.0,"reason":"<เหตุผลสั้นๆ>"}

กติกา:
- ถ้าตีความได้ว่าเป็นการบันทึกตัวเลข → type=financial, canonical=""
- ถ้าตีความเป็นคำสั่งใดคำสั่งหนึ่งได้ → type=command, canonical=คำสั่ง canonical นั้นเป๊ะ (ใช้ถ้อยคำตามรายการด้านบน)
- ถ้าเดาไม่ได้จริงๆ → type=unknown, canonical="", confidence ต่ำ
